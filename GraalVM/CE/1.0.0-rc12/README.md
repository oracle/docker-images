...
The images are intended for use in the **FROM** field of a downstream Dockerfile. For example, specify `FROM oracle/graalvm-ce:1.0.0-rc12`.
...
```
docker build -t oracle/graalvm-ce:1.0.0-rc12 .
```
