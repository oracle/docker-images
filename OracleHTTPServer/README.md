...
===================================
This project includes quick start dockerfiles and samples for standalone Oracle HTTP Server 12.2.1.4 and JDK 8 and 14.1.1.0 bnd JDK 17 and 21 based on Oracle Linux 8 and 9.
