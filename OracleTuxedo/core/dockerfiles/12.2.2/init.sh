#!/bin/bash
echo "Sample Docker build files to facilitate installation, and environment setup for DevOps users. For more information about Oracle Tuxedo please see the Oracle Tuxedo Online Documentation(http://docs.oracle.com/cd/E72452_01/tuxedo/docs1222/index.html)."
echo ""
