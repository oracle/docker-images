      ...
      if opt in ('--help'):
         ...
         stdout_handler.handle(oralogger)
           ...
           if ocommon.check_key("OP_TYPE",oenv.get_env_dict()):
              ...
              oenv.add_custom_variable("OP_TYPE","miscops")
      elif opt in ('--updatecdp'):
           file_name = oenv.logfile_name("UPDATE_CDP")
           oralogger.filename_ =  file_name
           ocommon.log_info_message("=======================================================================",file_name)
           oenv.add_custom_variable("UPDATE_CDP",arg)
           oenv.add_custom_variable("CUSTOM_RUN_FLAG","true")
           if ocommon.check_key("OP_TYPE",oenv.get_env_dict()):
              oenv.update_key("OP_TYPE","miscops")
           else:
           ...
           file_name = oenv.logfile_name("ONS")
           oralogger.filename_ =  file_name
           ocommon.log_info_message("=======================================================================",file_name)
           oenv.add_custom_variable("ONS",arg)
           oenv.add_custom_variable("CUSTOM_RUN_FLAG","true")
           if ocommon.check_key("OP_TYPE",oenv.get_env_dict()):
              oenv.update_key("OP_TYPE","miscops")
           else:
              oenv.add_custom_variable("OP_TYPE","miscops")
      elif opt in ('--updatesidprofile'):
           file_name = oenv.logfile_name("SIDPROFILEUPDATE")
           oralogger.filename_ =  file_name
           ocommon.log_info_message("=======================================================================",file_name)
           oenv.add_custom_variable("SID_PROFILE_UPDATE",arg)
           oenv.add_custom_variable("CUSTOM_RUN_FLAG","true")
           if ocommon.check_key("OP_TYPE",oenv.get_env_dict()):
              oenv.update_key("OP_TYPE","miscops")
           else:
