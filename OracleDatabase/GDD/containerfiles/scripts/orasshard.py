...
class OraSShard:
      ...
      def __init__(self,oralogger,orahandler,oraenv,oracommon):
        ...
        try:
          ...
          oracommon.log_info_message(ex_type.__name__,self.file_name)
          oracommon.log_info_message(ex_value,self.file_name)
          oracommon.log_info_message(stack_trace,self.file_name)
      def setup(self):
          """
