...
**NOTE:** Oracle Globally Distributed Database using Oracle Restart in Podman Containers is NOT available for Oracle AI Database 26ai Free version.
...
To build the Container Image, Please refer [Building Extended Oracle RAC Database Container Image with Oracle Globally Distributed Database Feature](../../../README.md#building-extended-oracle-rac-database-container-image-with-oracle-globally-distributed-database-feature)
