...
```bash
./buildExtensions.sh -x truecache -b oracle/database:23.26.1-ee -t oracle/database-ext-truecache:23.26.1-ee
```

Free example:

```bash
./buildExtensions.sh -x truecache -b oracle/database:23.26.1-free -t oracle/database-ext-truecache:23.26.1-free
```
...
oracle/database-ext-truecache:23.26.1-ee
```
...
-e ENABLE_FORCE_LOGGING=true \
-v ${HOST_DATA_ROOT}/trueCache/prod:/opt/oracle/oradata \
oracle/database-ext-truecache:23.26.1-free
```
...
```bash
IMAGE=oracle/database-ext-truecache:23.26.1-ee
...
```bash
IMAGE=oracle/database-ext-truecache:23.26.1-free
