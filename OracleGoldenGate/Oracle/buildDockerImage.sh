...
# Description: script to build a Docker image for GoldenGate for Oracle Database
# 
...
Builds a Docker Image for Oracle GoldenGate for Oracle Database
...
EOF
  ...
  echo "Oracle GoldenGate for Oracle Database Docker Image was NOT successfully created. Check the output and correct any reported problems with the docker build operation."
fi
