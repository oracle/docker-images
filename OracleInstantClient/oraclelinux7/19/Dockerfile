...
#
# Execute:
#      $ docker build --pull -t oraclelinux7-instantclient:19 .
#      $ docker run -ti --rm oraclelinux7-instantclient:19 sqlplus /nolog
#
# NOTES
# -----
#
...
#
#   docker run -v /my/host/wallet_dir:/usr/lib/oracle/19.15/client64/lib/network/admin:Z,ro . . .
#
