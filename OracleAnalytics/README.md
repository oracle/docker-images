...
Download the binary of FMW Infrastructure into folder `OracleFMWInfrastructure/dockerfiles/12.2.1.4`.
...
The BI image does not support scale-out, or upgrading to any future Oracle Analytics Server patchset release.
