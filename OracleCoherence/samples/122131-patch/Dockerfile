...
# ----------------------------------
# (1) p28173552_122130_Generic.zip
...
# Run:
#      $ sudo docker build -t oracle/coherence:12.2.1.3.1 .
#
...
# -------------------------------------------------------------
ENV PATCH_PKG="p28173552_122130_Generic.zip"
...
RUN cd /u01 && $JAVA_HOME/bin/jar xf /u01/$PATCH_PKG && cd - && \
    cd /u01/122131 && $ORACLE_HOME/OPatch/opatch apply -silent && cd - && \
    rm -rf /u01/122131 && rm /u01/$PATCH_PKG
