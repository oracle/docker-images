...
At the end of this configuration there may be 4 containers running:
...
### 4. Obtain the SOA 12.2.1.4.0 Docker image

You can either build the SOA image with the Docker file provided or use the already available Oracle SOA Suite (12.2.1.4.0) image in the [Oracle Container Registry](https://container-registry.oracle.com).
